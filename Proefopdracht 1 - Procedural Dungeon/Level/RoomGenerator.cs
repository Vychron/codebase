    ...
    public void ToFloor()
    {
        ...
        for (int i = 0; i < 3; i++)
            for (int j = 0; j < 3; j++)
            {
                ...
                {
                    o.GetComponent<MeshRenderer>().sharedMaterial = Resources.Load<Material>("Wall");
                    o.transform.position = new Vector3(o.transform.position.x, o.transform.position.y, 0.5f);
                }
